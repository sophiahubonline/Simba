(function() {
    ...
    const translations = {
        en: {
            ...
            nav: { thematics: 'Thematics', test: 'Test', visios: 'Visios', forum: 'Forum', contact: 'Contact Us', about: 'About Us' },
            ...
            visios: {
                pageTitle: 'Visios - SIMBA PROJECT',
                title: 'Visios',
                heroTitle: 'Calendar and video calls',
                ...
                upcomingTitle: 'Upcoming visios',
                noMeetings: 'No visio slots yet.',
                joinCall: 'Join call',
                startsAt: 'Starts at',
                endsAt: 'Ends at',
                ...
                ended: 'Ended',
                accessDenied: 'You do not have access to this visio.',
                roomTitle: 'Visio room',
        ...
        fr: {
            ...
            nav: { thematics: 'Thématiques', test: 'Test', visios: 'Visios', forum: 'Forum', contact: 'Contact', about: 'À propos' },
            ...
            visios: {
                ...
                heroCardBody: 'Crée des créneaux privés avec un admin, ou publie des visios de groupe pour tout le monde.',
                ...
                requestTitle: 'Demander une visio',
                requestBody: 'Réserve un créneau privé avec un admin. Toi seul et les admins pouvez le voir.',
                requestPlaceholder: 'Explique ce que tu veux discuter avec l’admin.',
                ...
                upcomingTitle: 'Visios à venir',
                noMeetings: 'Aucun créneau de visio pour le moment.',
                joinCall: 'Rejoindre l’appel',
                startsAt: 'Commence à',
                endsAt: 'Se termine à',
                onlyGuests: 'Créneau privé. Seules les personnes invitées peuvent le voir.',
                publicMeeting: 'Visio publique',
                privateMeeting: 'Visio privée',
                joinNow: 'Rejoindre maintenant',
                waitForStart: 'Commence dans {time}',
                ended: 'Terminé',
                accessDenied: 'Tu n’as pas accès à cette visio.',
                roomTitle: 'Salle de visio',

    ...
    const translations = {
        en: {
            ...
            visios: {
                ...
                heroCardBody: 'Create private slots with an admin or publish group visios for everyone.',
                adminTitle: 'Admin calendar',
                adminBody: 'Create public slots for everyone or private slots for selected people only.',
                requestTitle: 'Request a visio',
        ...
        de: {
            ...
            visios: {
                pageTitle: 'Visios - SIMBA PROJECT',
                title: 'Visios',
                heroTitle: 'Kalender und Videoanrufe',
                ...
                heroCardBody: 'Erstelle private Termine mit einem Admin oder veröffentliche Gruppen-Visios für alle.',
                ...
                requestTitle: 'Eine Visio anfragen',
                ...
                upcomingTitle: 'Bevorstehende Visios',
                noMeetings: 'Noch keine Visio-Termine vorhanden.',
                ...
                privateMeeting: 'Privates Meeting',
                groupMeeting: 'Gruppen-Visio',
                privateAppointment: 'Privater Termin',
                joinNow: 'Jetzt beitreten',
                waitForStart: 'Startet in {time}',
                ended: 'Beendet',
                accessDenied: 'Du hast keinen Zugriff auf diese Visio.',
                roomTitle: 'Visio-Raum',
        ...
        es: {
            ...
            visios: {
                pageTitle: 'Visios - SIMBA PROJECT',
                title: 'Visios',
                heroTitle: 'Calendario y videollamadas',
                ...
                heroCardBody: 'Crea franjas privadas con un admin o publica visios de grupo para todo el mundo.',
                adminTitle: 'Calendario admin',
                adminBody: 'Crea franjas públicas para todo el mundo o franjas privadas para personas concretas.',
                requestTitle: 'Pedir una visio',
                ...
                upcomingTitle: 'Visios próximas',
                noMeetings: 'Aún no hay franjas de visio.',
                ...
                publicMeeting: 'Reunión pública',
                privateMeeting: 'Reunión privada',
                groupMeeting: 'Visio de grupo',
                privateAppointment: 'Cita privada',
                joinNow: 'Unirse ahora',
                waitForStart: 'Empieza en {time}',
                ended: 'Terminada',
                accessDenied: 'No tienes acceso a esta visio.',
                roomTitle: 'Sala de visio',
        ...
        it: {
            ...
            visios: {
                pageTitle: 'Visios - SIMBA PROJECT',
                title: 'Visios',
                heroTitle: 'Calendario e videochiamate',
                ...
                calendarTitle: 'Calendario',
                heroCardBody: 'Crea fasce private con un admin o pubblica visios di gruppo per tutti.',
                adminTitle: 'Calendario admin',
                adminBody: 'Crea fasce pubbliche per tutti o fasce private solo per persone selezionate.',
                requestTitle: 'Richiedi una visio',
                ...
                upcomingTitle: 'Visios in arrivo',
                noMeetings: 'Nessuna fascia visio per ora.',
                joinCall: 'Unisciti alla chiamata',
                startsAt: 'Inizia alle',
                endsAt: 'Finisce alle',
                onlyGuests: 'Fascia privata. Solo le persone invitate possono vederla.',
                publicMeeting: 'Riunione pubblica',
                privateMeeting: 'Riunione privata',
                groupMeeting: 'Visio di gruppo',
                privateAppointment: 'Appuntamento privato',
                joinNow: 'Unisciti ora',
                waitForStart: 'Inizia tra {time}',
                ended: 'Terminata',
                accessDenied: 'Non hai accesso a questa visio.',
                roomTitle: 'Sala visio',
